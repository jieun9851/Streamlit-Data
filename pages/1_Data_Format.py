...
# mvp_df = pd.DataFrame(columns=['problem','solution','answer','equation','python code','grade','type'])

# customPath = r'C:\Users\jieunpark\Desktop\추론 AI 과제\data_processing\all_data_result'
